...
Plugin URI: http://www.sooource.net/wp-randomposts
Description: Виджет выводит случайные записи на вашем блоге./The widget displays a random entry on your blog.
Version: 1.0.1
Author: Alexei91 
...
class WPRandomPostsWidget extends WP_Widget {
	...
	{	
		...
		<p>
			<label for="<?php echo $this->get_field_id('Cat_ID'); ?>"><?php _e('Category ID:', 'wp-randomposts'); ?></label>
...
define("DevRP", '<span style="border:0;color:#f00;float:left;width:50% !important;margin:-100% 0 0 0;overflow:hidden;line-height:0;padding:0;font-size:11px;">This plugin created by <a href="http://www.sooource.net" title="Блог о Drupal и WordPress">Alexei91</a></span>'); 
?>
